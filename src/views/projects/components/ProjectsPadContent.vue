<template>
  <div class="content-pad">
    <projects-pad-item v-for="(item, index) in list" :key="item.id" :item="item" :index="index"></projects-pad-item>
  </div>
</template>

<script>
import ProjectsPadItem from './children/ProjectsPadItem'
export default {
  name: 'ProjectsPadContent',
  components: {
    ProjectsPadItem
  },
  data () {
